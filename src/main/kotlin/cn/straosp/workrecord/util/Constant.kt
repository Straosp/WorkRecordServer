...
object Constant {
    ...
    const val UPDATE_ACCOUNT_PASSWORD_FAILED_CODE = ACCOUNT_ERROR_PREFIX + 6
    const val UPDATE_ACCOUNT_PASSWORD_FAILED_MESSAGE = "密码更新失败"

    const val UPDATE_ACCOUNT_OLD_PASSWORD_FAILED_CODE = ACCOUNT_ERROR_PREFIX + 7
    const val UPDATE_ACCOUNT_OLD_PASSWORD_FAILED_MESSAGE = "旧密码错误"
